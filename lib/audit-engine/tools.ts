...
export const PLANS: PlanDefinition[] = [
  ...
  },
  {
    ...
    pricePerSeat: 20,
    minSeats: 1,
    features: ['Unlimited completions', '500 fast premium requests/mo', 'Unlimited slow requests', 'Claude 3.5 Sonnet & GPT-4o'],
    bestFor: ['coding'],
    isEnterprise: false,
    sourceUrl: 'https://cursor.com/pricing',
  },
  ...
  // Source: https://github.com/features/copilot#pricing
  {
    ...
    pricePerSeat: 10,
    minSeats: 1,
    features: ['Code completions', 'Copilot Chat', 'CLI assistance', 'Multi-model support'],
    bestFor: ['coding'],
    isEnterprise: false,
